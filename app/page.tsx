...
const Home = () => {
  ...
  const projects = [
    ...
    { title: 'Canadian High Schools', description: 'Led the development of a wiki platform where high school students can share tools and information while earning volunteer hours. My role focused on using Django to build a user-friendly interface.  ', imageUrl: '/chs-logo.png.png' ,link:'http://cahighschools.org/login'},
