...
const Home = () => {
  ...
  const projects = [
    ...
    { title: 'Discover UofT: DeerHacks', description: "A website that allows clubs at clubs at The University of Toronto to post upcoming events, and notify users. It uses a machine learning algorithm to generate tags for each event. ", imageUrl: '/discover-utm.png' ,link:'https://devpost.com/software/discover-utm'},
