...
const Home = () => {
  ...
  const projects = [
    ...
    {title:'Scholar', description: 'A reminder and note taking application that allows students to keep track of their schedule, the weather and any upcoming assessments', imageUrl: '/scholar.png' ,link:"https://scholar-j.vercel.app/"},
