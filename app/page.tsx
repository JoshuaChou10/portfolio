...
const Home = () => {
  ...
  const projects = [
    { title: 'Fraser Hacks', description: "The website for John Fraser Secondary Schools official hackathon, I was responsible for the animations and hackathon description.", imageUrl: '/hacks.png' ,link:'https://www.fraserhacks.ca/'},
